		...
		<div class="container container-fluid">
			...
			<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
				<ul class="nav navbar-nav">
					<li><a href="{{ url('/products/new') }}">New Product</a></li>
				</ul>
				...
				<form class="navbar-form navbar-left" role="search">
					...
					{{--<button type="submit" class="searchSubmit btn btn-default btn-info">Submit</button>--}}
					<button type="submit" class="searchSubmit btn btn-default btn-info">&#10148;</button>
				</form>
